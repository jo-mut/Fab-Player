...
public class VideosRecyclerAdapter extends RecyclerView.Adapter<VideoViewHolder> {
    ...
    public VideosRecyclerAdapter(Context mContext, List<HashMap<String, String>> videos ) {
    ...
    public void onBindViewHolder(final @NonNull VideoViewHolder holder, final int position) {
        ...
        holder.videoRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(VideosRecyclerAdapter.GALLERY_VIDEO, videos.get(position).get(Function.KEY_PATH));
                intent.putExtra(VideosRecyclerAdapter.VIDEO_NAME, videos.get(position).get(Function.KEY_NAME));
