...
public class VideosLinearAdapter extends RecyclerView.Adapter<VideoViewHolder> {
    ...
    public VideosLinearAdapter(Context mContext, List<HashMap<String, String>> videos ) {
    ...
    public void onBindViewHolder(final @NonNull VideoViewHolder holder, final int position) {
        ...
        holder.videoRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(VideosLinearAdapter.GALLERY_VIDEO, videos.get(position).get(Function.KEY_PATH));
                intent.putExtra(VideosLinearAdapter.VIDEO_NAME, videos.get(position).get(Function.KEY_NAME));
